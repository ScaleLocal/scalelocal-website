...
Their site advertises review and compilation but never the word 'audit';
...
BANNED = [
    # CORRECTED 2026-07-31 after re-verifying the live site. The first service
    # bullet on their Accounting & Tax Services page reads verbatim "Review and
    # Compilation of small business financial statements", so compilation AND
    # review are advertised by the firm and must not be banned. The word "audit"
    # appears nowhere on their site, so audits stay banned.
    'audit services', 'audit engagement', 'our audit', 'we audit',
    'we perform audits', 'audited financial statements', 'broker-dealer audit',
