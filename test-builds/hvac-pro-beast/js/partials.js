...
(function(){
  ...
  function injectCallBar(){
    if(document.querySelector('.mobile-call-bar')) return;
    var a=document.createElement('a');
    a.className='mobile-call-bar'; a.href='tel:7813508141';
    a.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg><span>Schedule an Appointment &middot; Call Now</span>';
    document.body.appendChild(a);
    var shown=false;
    window.addEventListener('scroll',function(){
      var s=window.scrollY>260;
      if(s!==shown){ shown=s; a.classList.toggle('show',s); }
    },{passive:true});
  }
  function boot(){ inject(); injectCallBar(); }
